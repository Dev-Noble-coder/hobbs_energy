        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className='relative'>
              ...
              <div className='absolute bottom-5 flex justify-between px-5 gap-5 items-center w-full  text-white text-sm text-center'>
                  <div className='flex-1 bg-white/10 backdrop-blur-sm py-2 px-3 rounded-md border border-white/50'>
                    <p>Bank Road, Ado-Ekiti.</p>
                  </div>
                  <div className='flex-1 bg-white/10 backdrop-blur-sm py-2 px-3 rounded-md border border-white/50 flex justify-center items-center gap-2 cursor-pointer'>
