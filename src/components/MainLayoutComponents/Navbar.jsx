...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="absolute top-3 left-5 right-5 lg:left-40 lg:right-40 bg-transparent backdrop-blur-sm text-white rounded-full  shadow-sm z-40 border border-white/50">
